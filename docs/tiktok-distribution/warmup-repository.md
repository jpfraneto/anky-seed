...
Purpose: build a curated repository of TikTok videos that a new Anky account can watch, save, and occasionally comment on so its For You feed learns the right neighborhood: post-seeking, direct-path, anti-performance, serious practice, writing-as-excavation, and child/story mirror material.
...
- Bridges into writing, art, music, unconscious material, story, parenting, or children as mirrors.
...
- Ring 1 direct-path / post-seeking: 45%
- Anti-spiritual-ego / marketplace critique: 20%
- Serious practice fatigue / meditation depth: 15%
- Writing, art, unconscious, story: 12%
- Parenting / child-as-mirror: 8%

The account should feel like a witness with a writing practice underneath, not like a generic spirituality account.
...
- `ring`: `ring_1`, `ring_2`, `ring_3`, or `avoid`
- `pillar`: one of `seeker_trap`, `mirror_mechanism`, `anti_performance`, `child_story_bridge`, `founder_confession`, `practice_fatigue`, `creative_excavation`, `parenting_mirror`, `marketplace_critique`
