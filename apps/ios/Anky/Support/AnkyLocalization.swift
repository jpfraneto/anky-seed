...
enum AnkyLocalization {
    ...
    private static let translations: [String: [AnkyLocalizedKey: String]] = [
        "en": [
            ...
            .tabMap: "Map",
            .tabYou: "You",
            .faceIDPrompt: "Protect your Anky with Face ID. Your writing is local, and this keeps access private on this phone.",
            .activateFaceID: "Activate Face ID",
            .notNow: "Not now",
            .protectFaceIDReason: "Protect ANKY with Face ID.",
        ...
        "es": [
            ...
            .tabMap: "Mapa",
            .tabYou: "Tu",
            .faceIDPrompt: "Protege tu Anky con Face ID. Tu escritura es local, y esto mantiene privado el acceso en este telefono.",
            .activateFaceID: "Activar Face ID",
            .notNow: "Ahora no",
            .protectFaceIDReason: "Protege ANKY con Face ID.",
        ...
        "pt": [
            ...
            .tabMap: "Mapa",
            .tabYou: "Voce",
            .faceIDPrompt: "Proteja seu Anky com Face ID. Sua escrita fica local, e isso mantem o acesso privado neste telefone.",
            .activateFaceID: "Ativar Face ID",
            .notNow: "Agora nao",
            .protectFaceIDReason: "Proteja o ANKY com Face ID.",
        ...
        "fr": [
            ...
            .tabMap: "Carte",
            .tabYou: "Vous",
            .faceIDPrompt: "Protegez votre Anky avec Face ID. Votre ecriture reste locale, et cela garde l'acces prive sur ce telephone.",
            .activateFaceID: "Activer Face ID",
            .notNow: "Pas maintenant",
            .protectFaceIDReason: "Proteger ANKY avec Face ID.",
        ...
        "de": [
            ...
            .tabMap: "Karte",
            .tabYou: "Du",
            .faceIDPrompt: "Schutze dein Anky mit Face ID. Dein Schreiben bleibt lokal, und der Zugriff auf diesem Telefon bleibt privat.",
            .activateFaceID: "Face ID aktivieren",
            .notNow: "Nicht jetzt",
            .protectFaceIDReason: "ANKY mit Face ID schutzen.",
        ...
        "it": [
            ...
            .tabMap: "Mappa",
            .tabYou: "Tu",
            .faceIDPrompt: "Proteggi il tuo Anky con Face ID. La tua scrittura resta locale, e questo mantiene privato l'accesso su questo telefono.",
            .activateFaceID: "Attiva Face ID",
            .notNow: "Non ora",
            .protectFaceIDReason: "Proteggi ANKY con Face ID.",
        ...
        "ja": [
            ...
            .tabMap: "マップ",
            .tabYou: "あなた",
            .faceIDPrompt: "Face IDでAnkyを保護しましょう。書いた内容はこの端末に保存され、アクセスをこの電話内でプライベートに保てます。",
            .activateFaceID: "Face IDを有効にする",
            .notNow: "今はしない",
            .protectFaceIDReason: "Face IDでANKYを保護します。",
        ...
        "ko": [
            ...
            .tabMap: "지도",
            .tabYou: "나",
            .faceIDPrompt: "Face ID로 Anky를 보호하세요. 글은 이 기기에 로컬로 저장되고, 이 전화에서 접근을 비공개로 유지합니다.",
            .activateFaceID: "Face ID 켜기",
            .notNow: "나중에",
            .protectFaceIDReason: "Face ID로 ANKY를 보호합니다.",
        ...
        "zh": [
            ...
            .tabMap: "地图",
            .tabYou: "你",
            .faceIDPrompt: "使用 Face ID 保护你的 Anky。你的书写保存在本机，这会让此手机上的访问保持私密。",
            .activateFaceID: "开启 Face ID",
            .notNow: "暂时不要",
            .protectFaceIDReason: "使用 Face ID 保护 ANKY。",
