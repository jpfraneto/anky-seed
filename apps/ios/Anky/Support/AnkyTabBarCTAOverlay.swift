    ...
    var body: some View {
        GeometryReader { geometry in
            if controller.isPresented {
                ...
                Button {
                    ...
                    ZStack {
                        ...
                        Text(AnkyLocalization.ui(controller.title))
                            ...
                            .shadow(
                                color: TabBarCTAPalette.glowGold.opacity(controller.isLoading ? 0.45 : 0.25),
                    ...
                    .background {
                        ZStack {
                            ...
                            Capsule()
                                .strokeBorder(Color.ankyInk.opacity(0.10), lineWidth: 0.8)
                                .blur(radius: 0.6)
                        }
                    }
                    .shadow(
                ...
                .accessibilityLabel(AnkyLocalization.ui(controller.title))
                .accessibilityHint(controller.isLoading ? AnkyLocalization.ui("Your reflection is being received.") : "")
            }
        }
        .onAppear {
            isBreathing = true
        }
        .onChange(of: controller.streamTick) { _ in
...
private enum TabBarCTAPalette {
    static let purpleTop = Color.ankyGoldLight
    static let purpleBottom = Color.ankyGold
    static let violetGlow = Color.ankyGoldLight
    static let glowViolet = Color.ankyViolet
    static let glowGold = Color.ankyGold
    static let borderGold = Color.ankyGoldLight
    static let borderViolet = Color.ankyViolet
    static let borderGoldDeep = Color.ankyGold
    static let gold = Color.ankyGold
    static let paperBright = Color.ankyPaper
}
