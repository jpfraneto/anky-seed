...
struct WritingSessionEngine {
    ...
    mutating func closeWithTerminalSilence(after terminalSilenceMs: Int64 = AnkyDuration.defaultTerminalSilenceMs) {
        writer.closeWithTerminalSilence(after: terminalSilenceMs)
    }
