        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    HStack(spacing: 0) {
                        CheckInModeButton(title: "Write", systemImage: "leaf", action: openWrite)
                        CheckInModeButton(title: "Talk", systemImage: "mic.fill", isEmphasized: true, action: openTalk)
                        CheckInModeButton(title: "Image", systemImage: "camera", action: openImage)
                    }
                    .frame(height: 146)
                    ...
                    Text("For when you need more space.")
...
private struct CheckInSessionView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Choose image", isPresented: $showsImageSourceDialog, titleVisibility: .visible) {
                ...
                if viewModel.mode == .talk {
                    HStack {
                        HStack(spacing: 8) {
                            ...
                            Text(viewModel.recordingState == .paused ? "Paused" : "Listening...")
                        }
                        .foregroundStyle(CheckInPalette.lavender)
                        Spacer()
                        Text("03:12")
    ...
    private var bottomActionBar: some View {
        ...
        case .composing:
            composingActionBar
        case .reflecting:
            ReflectButton(title: "Reflecting", subtitle: "Anky is reading what you shared", systemImage: "sparkle", isLoading: true) { }
                .disabled(true)
    ...
    private var composingActionBar: some View {
        if viewModel.mode == .talk, viewModel.recordingState == .recording {
            ...
            HStack(spacing: 14) {
                ...
                ReflectButton(title: "Reflect", subtitle: "Create my reflection from what I said", systemImage: "sparkle") {
                    viewModel.reflect()
                }
            ...
            ReflectButton(title: "Reflect", subtitle: "Anky will reflect for you", systemImage: "sparkle") {
                viewModel.reflect()
            }
            .disabled(!viewModel.canReflect)
            .opacity(viewModel.canReflect ? 1 : 0.55)
