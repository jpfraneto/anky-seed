...
struct AnkyReflectionCreditsSheet: View {
    ...
    var body: some View {
        ...
        .overlay(sheetBorder)
        .shadow(color: Color.ankyViolet.opacity(0.18), radius: 18, x: 0, y: -6)
            ...
            Button {
                ...
                ZStack {
                    Circle()
                        ...
                        .background(
                            Circle()
                                .fill(AnkyReflectionCreditsPalette.purpleDeep.opacity(0.18))
                        )
    ...
    private var sheetBackground: some View {
        ZStack {
            ...
            LinearGradient(
                colors: [
                    Color.ankyPaper.opacity(0.98),
                    Color.ankyPaperDeep.opacity(0.85),
                    AnkyReflectionCreditsPalette.almostBlack
                ],
                startPoint: .top,
                endPoint: .bottom
...
private struct AnkyReflectionCreditPackRow: View {
    ...
    var body: some View {
        ...
        .accessibilityHint(AnkyLocalization.ui("Double tap to buy."))
    }
                ...
                .fill(
                    RadialGradient(
                        colors: [
                            ...
                            AnkyReflectionCreditsPalette.purpleDeep.opacity(0.18),
                ...
                .fill(
                    LinearGradient(
                        colors: [
                            ...
                            Color.ankyPaperDeep.opacity(0.65)
                        ],
                        startPoint: .topLeading,
                        endPoint: .bottomTrailing
                    )
...
private struct AnkyReflectionCreditEmptyRow: View {
    ...
    var body: some View {
        Text(AnkyLocalization.ui(text))
            ...
            .frame(height: 68)
            .background(Color.ankyPaperDeep.opacity(0.55), in: RoundedRectangle(cornerRadius: 16, style: .continuous))
            .overlay(
                RoundedRectangle(cornerRadius: 16, style: .continuous)
...
extension View {
    ...
    @ViewBuilder
    func ankyCreditsSheetChrome() -> some View {
...
private enum AnkyReflectionCreditsPalette {
    static let almostBlack = Color.ankyPaper
    static let purpleDeep = Color.ankyViolet
