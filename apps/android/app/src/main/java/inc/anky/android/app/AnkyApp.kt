...
import inc.anky.android.feature.painting.PaintingHomeView
...
fun AnkyApp(
    ...
    AnkyTheme {
        ...
        val tabs = listOf(AnkyRoute.Painting, AnkyRoute.Map, AnkyRoute.You)
        ...
        LaunchedEffect(lockState.value) {
            if (lockState.value == LockState.Unlocked) {
                ...
                runCatching { container.entitlementStore.ensureConfigured() }
                container.entitlementStore.start()
                rootScope.launch {
        ...
        val shouldShowOnboarding =
            showsOnboarding.value &&
                lockState.value == LockState.Unlocked &&
                (currentRoute == AnkyRoute.Painting.route || currentRoute == AnkyRoute.Write.route || currentRoute == null) &&
        ...
        LaunchedEffect(deepLinkUri, settings.onboardingCompleted, lockState.value) {
            val uri = deepLinkUri ?: return@LaunchedEffect
            if (lockState.value != LockState.Unlocked) return@LaunchedEffect
            when (uri) {
                "anky://painting" -> {
                    showsOnboarding.value = false
                    navController.navigate(AnkyRoute.Painting.route) {
                        launchSingleTop = true
                        popUpTo(AnkyRoute.Painting.route) { inclusive = false }
                    }
                    onDeepLinkHandled()
                }
                "anky://write" -> {
        ...
        Box(Modifier.fillMaxSize()) {
            Scaffold(
                ...
                bottomBar = {
                    if (
                        currentRoute != AnkyRoute.Write.route &&
                            currentRoute != AnkyRoute.Painting.route &&
                                ...
                                NavigationBarItem(
                                    ...
                                    onClick = {
                                        navController.navigate(tab.route) {
                                            launchSingleTop = true
                                            popUpTo(AnkyRoute.Painting.route)
                                        }
                                    },
                                    label = { Text(tabLabel) },
                                    icon = {
                ...
                NavHost(
                    ...
                    startDestination = AnkyRoute.Painting.route,
                    modifier = Modifier.fillMaxSize(),
                    ...
                    composable(AnkyRoute.Painting.route) {
                        if (shouldShowOnboarding) {
                            ...
                            PaintingHomeView(
                                dependencies = container.paintingHomeDependencies,
                                onWrite = {
                                    navController.navigate(AnkyRoute.Write.route) {
                                        launchSingleTop = true
                                    }
                                ...
                                onChooseApps = { navController.navigate(AnkyRoute.You.route) },
                                onContinueSetup = { navController.navigate(AnkyRoute.You.route) },
                                onOpenSettings = { navController.navigate(AnkyRoute.You.route) },
                                onOpenArchive = { navController.navigate(AnkyRoute.MapAllAnkys.route) },
                                onOpenYou = { navController.navigate(AnkyRoute.You.route) },
                                onEmergencyBreath = { navController.navigate(AnkyRoute.Write.route) },
                                paywallSheet = { origin, onDismiss ->
                                    PaywallSheet(
                    ...
                    composable(AnkyRoute.Write.route) {
                        if (shouldShowOnboarding) {
                            ...
                            WriteScreen(
                                ...
                                onCloseToMap = { navController.navigate(AnkyRoute.Painting.route) },
                    ...
                    composable(
                        ...
                        val viewModel = remember(hash, settings.mirrorBaseUrl) {
                            RevealViewModel(
                                ...
                                entitledForGatingProvider = { container.entitlementStore.isEntitledForGating },
                            )
                        }
                        RevealScreen(
                            viewModel = viewModel,
...
private fun presenceSequence(route: String?, writeRitualComplete: Boolean): AnkySequenceName =
    when (route) {
        AnkyRoute.Painting.route, null -> AnkySequenceName.IdleFront
        AnkyRoute.Write.route -> if (writeRitualComplete) AnkySequenceName.Celebrate else AnkySequenceName.FindingThread
...
private fun AnkyRoute.icon() =
    when (this) {
        AnkyRoute.Painting -> Icons.Outlined.Edit
...
private fun AnkyRoute.isSelectedForRoute(currentRoute: String?): Boolean =
    when (this) {
        AnkyRoute.Painting -> currentRoute == AnkyRoute.Painting.route
        AnkyRoute.You -> currentRoute == AnkyRoute.You.route
